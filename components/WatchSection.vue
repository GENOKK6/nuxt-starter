...
const getTypeColor = (type) => {
  const colors = {
    'Article': 'bg-amber-900/20 text-amber-500',
    'Tutoriel': 'bg-green-900/20 text-green-400',
    'Guide': 'bg-orange-900/20 text-orange-500'
  }
...
<template>
  <section id="watch" class="py-20 bg-black transition-colors duration-300">
    <div class="container mx-auto px-4">
      ...
      <div class="mb-16">
        <div class="bg-gray-900 rounded-2xl p-8 border border-gray-800 shadow-lg">
          <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            <div class="flex-1">
              <span class="inline-block px-4 py-1 bg-amber-600 text-white text-sm font-bold rounded-full mb-4">
                🎯 Thème actuel
              </span>
            ...
            <div class="flex flex-wrap gap-3">
              <div
                ...
                :key="tool.name"
                class="bg-gray-800 rounded-xl px-4 py-3 shadow-md border border-gray-700 text-center min-w-[100px] hover:shadow-lg transition-shadow"
              >
      ...
      <div class="mb-12">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div
            ...
            :key="article.id"
            class="bg-gray-900 rounded-xl p-6 border border-gray-800 hover:shadow-lg hover:border-amber-500 transition-all duration-300 flex flex-col"
          >
            <!-- Header -->
      ...
      <div class="bg-gray-900 rounded-2xl p-8 border border-gray-800">
        ...
        <div class="grid md:grid-cols-4 gap-6">
          <div class="bg-gray-800 rounded-xl p-5 text-center shadow-md border border-gray-700">
            ...
            <p class="text-sm text-gray-400">Recherche et collecte d'information via mes outils</p>
          </div>
          ...
          <div class="bg-gray-800 rounded-xl p-5 text-center shadow-md border border-gray-700">
            ...
            <p class="text-sm text-gray-400">Filtrage des articles pertinents par catégorie</p>
          </div>

          <div class="bg-gray-800 rounded-xl p-5 text-center shadow-md border border-gray-700">
            <div class="w-12 h-12 bg-amber-900/40 rounded-full flex items-center justify-center mx-auto mb-3">
            ...
            <p class="text-sm text-gray-400">Résumé et prise de notes sur chaque source</p>
          </div>

          <div class="bg-gray-800 rounded-xl p-5 text-center shadow-md border border-gray-700">
            <div class="w-12 h-12 bg-orange-900/40 rounded-full flex items-center justify-center mx-auto mb-3">
              <svg class="w-6 h-6 text-yellow-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
              </svg>
            </div>
            <h4 class="font-semibold text-gray-900 dark:text-white mb-1">4. Archivage</h4>
            <p class="text-sm text-gray-400">Organisation et stockage pour consultation future</p>
          </div>
        </div>
      </div>
      ...
      <div class="mt-12 text-center">
        ...
        <NuxtLink
          to="/veille"
          class="inline-flex items-center gap-2 px-8 py-4 bg-linear-to-r from-amber-500 to-orange-600 text-white font-bold rounded-xl hover:scale-105 transition-all duration-300 shadow-xl"
        >
