    ...
    <div class="container">
      <nav class="simple-nav">
        <NuxtLink to="/" class="simple-logo">
          <span style="background: linear-gradient(135deg, var(--blue-600), var(--blue-800)); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text;">GK</span>
        </NuxtLink>
